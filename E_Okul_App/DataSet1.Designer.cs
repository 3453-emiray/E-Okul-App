...
namespace E_Okul_App {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TBLNOTLARDataTable : global::System.Data.TypedTableBase<TBLNOTLARRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TBLNOTLARRow AddTBLNOTLARRow(TBLDERSLERRow parentTBLDERSLERRowByFK_TBLNOTLAR_TBLDERSLER, int OGRID, byte SINAV1, byte SINAV2, byte SINAV3, byte PROJENOT, decimal ORTALAMA, bool DURUM) {
...
namespace E_Okul_App.DataSet1TableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT TBLOGRENCI.OGRID, TBLOGRENCI.OGRAD, TBLOGRENCI.OGRSOYAD, TBLKULUP.KULUPAD," +
                " TBLOGRENCI.OGRCINSIYET\r\nFROM     TBLOGRENCI INNER JOIN\r\n                  TBLKU" +
                "LUP ON TBLOGRENCI.OGRKULUP = TBLKULUP.KULUPID";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT TBLOGRENCI.OGRID, TBLOGRENCI.OGRAD, TBLOGRENCI.OGRSOYAD, TBLKULUP.KULUPAD," +
                " TBLOGRENCI.OGRCINSIYET\r\nFROM     TBLOGRENCI INNER JOIN\r\n                  TBLKU" +
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@OGRCINSIYET", global::System.Data.SqlDbType.NChar, 5, global::System.Data.ParameterDirection.Input, 0, 0, "OGRCINSIYET", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "UPDATE TBLOGRENCI\r\nSET          OGRSOYAD = @OGRSOYAD, OGRKULUP = @OGRKULUP, OGRAD" +
                " = @OGRAD, OGRCINSIYET = @OGRCINSIYET\r\nWHERE  (OGRID = @OGRID)";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@OGRCINSIYET", global::System.Data.SqlDbType.NChar, 5, global::System.Data.ParameterDirection.Input, 0, 0, "OGRCINSIYET", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int OgrenciGuncelle(string OGRSOYAD, global::System.Nullable<byte> OGRKULUP, string OGRAD, string OGRCINSIYET, int OGRID) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[3];
            if ((OGRSOYAD == null)) {
                command.Parameters[0].Value = global::System.DBNull.Value;
            }
            ...
            if ((OGRAD == null)) {
                ...
                command.Parameters[2].Value = ((string)(OGRAD));
            }
            if ((OGRCINSIYET == null)) {
                command.Parameters[3].Value = global::System.DBNull.Value;
            }
    ...
    public partial class TBLNOTLARTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [TBLNOTLAR] ([DERSID], [OGRID], [SINAV1], [SINAV2], [SINAV3], [PROJENOT], [ORTALAMA], [DURUM]) VALUES (@DERSID, @OGRID, @SINAV1, @SINAV2, @SINAV3, @PROJENOT, @ORTALAMA, @DURUM);
...
SELECT NOTID, DERSID, OGRID, SINAV1, SINAV2, SINAV3, PROJENOT, ORTALAMA, DURUM FROM TBLNOTLAR WHERE (NOTID = @NOTID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT NOTID, DERSID, OGRID, SINAV1, SINAV2, SINAV3, PROJENOT, ORTALAMA, DURUM\r\nF" +
                "ROM     TBLNOTLAR\r\nWHERE  (OGRID = @OGRID)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[1].CommandText = "UPDATE [TBLNOTLAR] SET [DERSID] = @DERSID, [OGRID] = @OGRID, [SINAV1] = @SINAV1, " +
                "[SINAV2] = @SINAV2, [SINAV3] = @SINAV3, [PROJENOT] = @PROJENOT, [ORTALAMA] = @OR" +
                "TALAMA, [DURUM] = @DURUM WHERE ([NOTID] = @Original_NOTID) ";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int NotGuncelle(global::System.Nullable<byte> DERSID, global::System.Nullable<int> OGRID, global::System.Nullable<byte> SINAV1, global::System.Nullable<byte> SINAV2, global::System.Nullable<byte> SINAV3, global::System.Nullable<byte> PROJENOT, global::System.Nullable<decimal> ORTALAMA, global::System.Nullable<bool> DURUM, int Original_NOTID) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            if ((DERSID.HasValue == true)) {
